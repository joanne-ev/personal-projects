...
| Global_Sales | Total number of sales worldwide (in millions)                 |
...
**Portfolio idea source:** DataCamp. Video game sales. https://www.datacamp.com/datalab/datasets/dataset-python-video-games-sales

**Dataset source:** Gregorut. (2016). Video game sales [Dataset]. Kaggle. 
